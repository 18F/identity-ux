...
window.LoginGov.I18n = {
  currentLocale: function currentLocale() {
    return this.__currentLocale || (this.__currentLocale = document.querySelector('html').lang);
  },
  strings: {},
  t: function t(key) {
    return this.strings[this.currentLocale()][key];
  },
...
window.LoginGov.I18n.strings['en']['devise.two_factor_authentication.otp_delivery_preference.instruction'] = 'You can change your choice the next time you sign in';

window.LoginGov.I18n.strings['en']['devise.two_factor_authentication.otp_delivery_preference.phone_unsupported'] = 'We\'re unable to make phone calls to people in %{location} at this time. You will receive your security code via text message';

window.LoginGov.I18n.strings['en']['devise.two_factor_authentication.otp_phone_label_info'] = 'Mobile or landline okay';

window.LoginGov.I18n.strings['en']['devise.two_factor_authentication.otp_phone_label_info_modile_only'] = 'Mobile only';
...
window.LoginGov.I18n.strings['en']['idv.modal.button.warning'] = 'Try again';
...
window.LoginGov.I18n.strings['en']['links.remove'] = 'Remove';

window.LoginGov.I18n.strings['en']['simple_form.required.text'] = 'This field is required';

window.LoginGov.I18n.strings['en']['valid_email.validations.email.invalid'] = 'Invalid email address format or domain entered. Correct the address and re-enter it.';
...
window.LoginGov.I18n.strings['es']['devise.two_factor_authentication.otp_delivery_preference.instruction'] = 'Puede cambiar su elección la próxima vez que inicie una sesión.';

window.LoginGov.I18n.strings['es']['devise.two_factor_authentication.otp_delivery_preference.phone_unsupported'] = 'NOT TRANSLATED YET';

window.LoginGov.I18n.strings['es']['devise.two_factor_authentication.otp_phone_label_info'] = 'El móvil o teléfono fijo está bien.';

window.LoginGov.I18n.strings['es']['devise.two_factor_authentication.otp_phone_label_info_modile_only'] = 'NOT TRANSLATED YET';
...
window.LoginGov.I18n.strings['es']['idv.modal.button.warning'] = 'Inténtelo de nuevo';
...
window.LoginGov.I18n.strings['es']['links.remove'] = 'Retirar';
...
window.LoginGov.I18n.strings['fr']['devise.two_factor_authentication.otp_delivery_preference.instruction'] = 'Vous pourrez changer votre choix la prochaine fois que vous vous connecterez';

window.LoginGov.I18n.strings['fr']['devise.two_factor_authentication.otp_delivery_preference.phone_unsupported'] = 'NOT TRANSLATED YET';

window.LoginGov.I18n.strings['fr']['devise.two_factor_authentication.otp_phone_label_info'] = 'Cellulaire ou ligne fixe est acceptable';

window.LoginGov.I18n.strings['fr']['devise.two_factor_authentication.otp_phone_label_info_modile_only'] = 'NOT TRANSLATED YET';
...
window.LoginGov.I18n.strings['fr']['idv.modal.button.warning'] = 'Essayez à nouveau';
...
window.LoginGov.I18n.strings['fr']['links.remove'] = 'Retirer';
